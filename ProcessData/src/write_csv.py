...
def main_UCF101(f_root, splits_root, csv_root='../data/ucf101/'):
    ...
    for which_split in [1,2,3]:
        ...
        with open(train_split_file, 'r') as f:
            for line in f:
                vpath = os.path.join(f_root, line.split(' ')[0].split('/')[1][0:-4]) + '/'
        ...
        with open(test_split_file, 'r') as f:
            for line in f:
                vpath = os.path.join(f_root, line.rstrip().split('/')[1][0:-4]) + '/'
...
if __name__ == '__main__':
    ...
    # main_UCF101(f_root='D:/VideoData/UCF101/frame',
    #             splits_root='D:/VideoData/UCF101/splits_classification')
